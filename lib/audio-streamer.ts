...
export class AudioStreamer {
  ...
  constructor(public context: AudioContext, volume: number = 1.0) {
  ...
  stop() {
    ...
    const lastGain = this.gainNode.gain.value;
    ...
    setTimeout(() => {
      ...
      this.gainNode = this.context.createGain();
      this.gainNode.gain.setValueAtTime(lastGain, this.context.currentTime);
      this.gainNode.connect(this.context.destination);
    }, 200);
  }
